    ...
    <div className="flex flex-col justify-between h-full">
      ...
      <div className={`bg-primary-white flex flex-col border-r-light-lines border-r-1 h-full z-10 transition-all duration-700 
        ...
        <div className="px-6 pb-12 flex items-start gap-6 flex-col bg-primary-white">
          ...
          <button className="heading-md flex text-medium-grey gap-3.5 cursor-pointer pl-1.5" onClick={() => toggleOpen(prev => !prev)}>
      ...
      <button className="p-1 w-14 h-12 rounded-r-full bottom-0 absolute bg-main-purple mb-8 cursor-pointer flex items-center justify-center" onClick={() => toggleOpen(prev => !prev)}>
